            ...
            <form onSubmit={handleSubmit} className="space-y-5" noValidate>
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full border-b-2 py-2.5 px-1 text-gray-800 font-medium placeholder:text-gray-300 focus:outline-none focus:border-primary bg-transparent ${
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={handleChange}
                    placeholder="••••••••"
                    className={`w-full border-b-2 py-2.5 px-1 pr-10 text-gray-800 font-medium placeholder:text-gray-300 focus:outline-none focus:border-primary bg-transparent ${
